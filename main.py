...
class Qr_Generator:
    def __init__(self,root):
        ...
        self.root.title("Qr Generator | Developed By Moss")
        ...
        lbl_designation=Label(emp_Frame,text="Designation",font=("times new roman",15,'bold'),bg='white').place(x=20,y=200)
        ...
        txt_designation=Entry(emp_Frame,font=("times new roman",15),textvariable=self.var_designation,bg='lightyellow').place(x=200,y=200)





        btn_generate=Button(emp_Frame,text='QR Generator',command=self.generate,font=("times new roman",18,'bold'),bg='#2196f3',fg='white').place(x=90,y=250,width=200,height=30)
        ...
        self.qr_code=Label(qr_Frame,text='No Qr available',font=('times new roman',15),bg='#3f51b5',fg='white',bd=1,relief=RIDGE)
